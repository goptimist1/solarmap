...
REGION_DATA = {
    ...
    "경상북도": {
        ...
        "경주시": ["건천읍", "외동읍", "감포읍", "안강읍", "양남면", "문무대왕면", "내남면", "산내면", "서면", "현곡면", "강동면", "천북면", "중부동", "황오동", "성건동", "황남동", "월성동", "선도동", "용강동", "황성동", "동천동", "불국동", "보덕동"],
        "구미시": ["선산읍", "고아읍", "무을면", "옥성면", "도개면", "해평면", "산동읍", "장천면", "송정동", "원평동", "지산동", "도량동", "선주원남동", "형곡1동", "형곡2동", "신평1동", "신평2동", "비산동", "공단동", "광평동", "상모사곡동", "임오동", "인동동", "진미동", "양포동"],
        ...
        "안동시": ["풍산읍", "와룡면", "북후면", "서후면", "풍천면", "일직면", "남후면", "남선면", "임하면", "길안면", "임동면", "예안면", "도산면", "녹전면", "중구동", "명륜동", "옥동", "송하동", "용상동", "서구동", "태화동", "평화동", "안기동", "강남동"],
...
sigungu_default = sigungu_options.index("강서구") if (sido == "부산광역시" and "강서구" in sigungu_options) else 0

with col2:
    sigungu = st.selectbox("시/군/구", sigungu_options, index=sigungu_default)

dong_options = REGION_DATA[sido][sigungu]
dong_default = dong_options.index("녹산동") if (sido == "부산광역시" and sigungu == "강서구" and "녹산동" in dong_options) else 0
